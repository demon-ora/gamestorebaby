  ...
  <div class="container game" style="margin: 0px ;display: inline; padding: 0;">
      <div class="mix action all xd" >
          ...
          require_once 'database.php';
           ...
           $sql = "SELECT * FROM game where catagories=1 && type='action'";
    ...
    <h1 class="card-text" style="text-align: center;"><?php echo $value['title']?></h1>
      ...
      <?php } ?>
        ...
        <?php 
          require_once 'database.php';
           //query to select data from category table
           $sql = "SELECT * FROM game where  catagories=1 && type='arcade'";
           //execute query and get result object
           $result = $connection->query($sql);
    ...
    <h1 class="card-text" style="text-align: center;"><?php echo $value['title']?></h1>
      ...
      <?php } ?>
        ...
        <?php 
          require_once 'database.php';
           //query to select data from category table
           $sql = "SELECT * FROM game where catagories=1 && type='puzzel'";
           //execute query and get result object
           $result = $connection->query($sql);
    ...
    <h1 class="card-text" style="text-align: center;"><?php echo $value['title']?></h1>
      ...
      <?php } ?>
       ...
       <?php 
          require_once 'database.php';
           //query to select data from category table
           $sql = "SELECT * FROM game where  catagories=1 && type='adventure'";
           //execute query and get result object
           $result = $connection->query($sql);
    ...
    <h1 class="card-text" style="text-align: center;"><?php echo $value['title']?></h1>
      ...
      <?php } ?>
       ...
       <?php 
          require_once 'database.php';
           //query to select data from category table
           $sql = "SELECT * FROM game where  catagories=1 && type='sport'";
           //execute query and get result object
           $result = $connection->query($sql);
